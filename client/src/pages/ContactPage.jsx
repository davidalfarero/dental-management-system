...
const ContactPage = () => {
  return (
    <div className='max-w-5xl mx-auto pt-15 md:pt-20 pb-8'>
      <SectionTitle
        title={
          <>
      ...
      />
      <div className='grid md:grid-cols-[60%_40%] gap-4 px-4 md:px-0'>

        <div className='px-4 py-8 space-y-4'>

          <div className='flex items-center gap-2'>
            <h1 className=' flex-none text-xl md:text-4xl'>Contact Us</h1>
            <div className='bg-base-content/20 h-[2px] w-full'></div>
          </div>

          <p className='text-base-content/60'>
            We’re here to help with any questions or booking needs you have. Reach out and we’ll get back to you as soon as possible.
          </p>

          <div className='flex items-center gap-2'>
            <p className="flex-none text-sm text-primary font-semibold">Get In Touch</p>
            <div className='bg-base-content/20 h-[1px] w-full'></div>
          </div>

          <div className='grid md:grid-cols-2 gap-2'>
            <div className='space-y-4'>
              <div className="flex gap-2">
                <Phone className="flex-none size-6 text-primary" />
                <p className="text-base-content/60">+639-123-456-789</p>
              </div>
              <div className="flex gap-2">
                <Mail className="flex-none size-6 text-primary" />
                <p className="text-base-content/60">support@mail.com</p>
              </div>
          ...
          <div className='flex items-center gap-2'>
            <p className="flex-none text-sm text-primary font-semibold">Follow Us</p>
            <div className='bg-base-content/20 h-[1px] w-full'></div>
          </div>
